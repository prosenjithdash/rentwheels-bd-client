    ...
    return (
        ...
        <div className="relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-[450px] bg-[url('/assets/AboutImages/b.webp')] bg-cover bg-center">
            ...
            <div className="relative z-10 flex items-center justify-center h-full text-white">
                <div className="  max-w-[1200px] mx-auto space-y-4 md:space-y-5 text-center">
                    <h2 className="inline-block mx-auto font-extrabold text-orange-500 rounded-full text-xs sm:text-sm md:text-base py-1 px-4 bg-gray-800 border border-orange-500 mb-5">EST. 2020. DHAKA, BANGLADESH</h2>
                    ...
                    <p className="text-sm md:text-xl lg:text-xl text-gray-300 max-w-2xl mx-auto ">
